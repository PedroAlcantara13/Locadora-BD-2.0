...
public class ConsultarFilme extends javax.swing.JFrame {
    ...
    private void AtualizaTable() {
        ...
        for (Filme tab : lista) {
            ...
            tableC.setValueAt(tab.getTitulo(), i, 1);
            tableC.setValueAt(tab.getAno(), i, 2);
            tableC.setValueAt(tab.getDuracao(), i, 3);
            tableC.setValueAt(tab.getCod_categoria(), i, 4);
            tableC.setValueAt(tab.getCod_classificacao(), i, 5);
            i++;
        }
